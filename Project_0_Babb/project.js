...
function fight(player1, player2)
{
    ...
    {
        document.getElementById("fightMessage").innerHTML = 'GAME OVER';
    }
    else
    {
        ...
        if (player1.toHit >= player2.ac)
        {
            ...
            {
                dmg = (3*(((Math.floor(Math.random() * 3)+1))+(player1.strMod*2)));
                player2.hp=player2.hp-dmg;
                document.getElementById("fightMessage").innerHTML = 
                `Player 2 takes ${dmg} damage <br>`;
            }
        ...
        if (player2.isAlive == true)
        {
            ...
            {
                dmg = (3*(((Math.floor(Math.random() * 3)+1))+(player2.strMod*2)));
                player1.hp=player1.hp-dmg;
                document.getElementById("fightMessage").innerHTML = 
                `Player 1 takes ${dmg} damage <br>`;
